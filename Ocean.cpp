...
//    stringstream ss;
    ...
    stringstream ss;
    ss << "<tick id=\"" << this->_counter << "\">\n";
    ss << "    <greedy_count>" << greedy_count << "</greedy_count>\n";
    ss << "    <crazy_count>" << crazy_count << "</cray_count>\n";
    ss << "    <lazy_count>" << lazy_count << "</lazy_count>\n";
    ss << "    <minimum>" << s_minim << "</minimum>\n";
    ss << "    <maximum>" << s_maxim << "</maximum>\n";
    ss << "    <average>" << s_avg << "</average>\n";
    ss << "    <first_remove>" << this->_first_remove << "</first_remove>\n";
    ss << "    <last_remove>" << this->_last_remove << "</last_remove>\n";
    ss << "    <p_ships_size>" << this->_pShips->size() << "</p_ships_size>\n";
    ss << "</tick>\n"; 
